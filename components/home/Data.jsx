...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Hey, I'm Ajay!
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <h3 className="home__subtitle">DevOps Enthusiast</h3>
        <p className="home__description">Hi there! I'm a passionate DevOps engineer with 1 year of experience in web application development. I specialize in automation, CI/CD pipelines, containerization, and cloud infrastructure, focusing on optimizing performance and delivering seamless user experiences.</p>
