            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">igajaygaur@gmail.com</span>

                        <a href="mailto:igajaygaur@gmail.com" className="contact__button">Write Me <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                    </div>
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">(+1) 3034379446</span>

                        <a href="https://api.whatsapp.com/send?phone=3034379446&text=Hello, I would like to connect with you!" className="contact__button">Text Me <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                    </div>
                    ...
                    <div className="contact__card">
                        ...
                        <a href="tel:+13034379446" className="contact__button">Call Me <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                    </div>
                </div>
            </div>
